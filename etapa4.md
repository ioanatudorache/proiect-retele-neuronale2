...
**Student:** Tudorache Ioana-Maria  
**Link Repository GitHub** https://github.com/ioanatudorache/proiect-retele-neuronale2
**Data:** 09.12.2025 
---
...
|----------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|
| Identificare a constelatiilor de catre amatori fara cunostiinte prealabile | Recunoastere automata din fotografie a cerului → identificare constelatie < 3 secunde                                                        | Retea Neuronala Convoluțională (CNN) + Modul Preprocesare Imagine |
| Educatie astronomica interactiva pentru pasionati                          | Afisare automata informatii stiintifice (distanta, magnitudine, spectru stelar) + context mitologic → experienta educationala în < 5 secunde | Bază de Date + Modul UI/Vizualizare + API Integrare Date                                            |
| Catalogarea automata a observatiilor astronomice amator                    | Recunoastere si etichetare automata din 100+ fotografii/noapte → reducere 80% timp de procesare manuala                                      | Pipeline Batch Processing + RN + Modul Export Date                                               |
